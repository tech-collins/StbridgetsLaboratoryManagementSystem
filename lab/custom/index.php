        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="banner-text text-center">
              <h1 class="white">Laboratory Management at your desk!!</h1>
        ...
        <div class="schedule-tab">
          <div class="col-md-4 col-sm-4 bor-left">
            ...
            <div class="medi-info">
              ...
              <p>I am text block. Edit this text from Appearance / Customize / Homepage header columns. Lorem ipsum 
          ...
          <div class="col-md-4 col-sm-4">
            <div class="medi-info">
              <h3>Emergency Case</h3>
              <p>I am text block. Edit this text from Appearance / Customize / Homepage header columns. Lorem ipsum dolor 
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-12">
          <div class="section-title">
            ...
            <hr class="botm-line">
            <p class="sec-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt 
