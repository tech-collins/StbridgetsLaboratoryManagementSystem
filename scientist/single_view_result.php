        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                if (isset($_GET["ref"])) {
                    ...
                    $appointmentNumber = mysqli_real_escape_string($con, $_GET["appNumber"]);
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-8 text-right m-b-30">
                            <div class="btn-group btn-group-sm">
                                <!-- <a href="#?ref=<?php //echo $patient_reference; ?>&appointment=<?php //echo $appointmentNumber; ?>" class="btn btn-white">CSV</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            ...
                                            $gottenMessage = testFormCategory($test);
                                            if($gottenMessage == "Haematology")
                                            {
                                                echo showSingleHaematologyTest($test,$appointmentNumber);
                                            }
                                            elseif($gottenMessage == "Clinical Chemistry")
                                            {
                                                echo showSingleClinicalChemistry($test,$appointmentNumber);
                                            }
                                            elseif($gottenMessage == "MicroBiology/Parasitology")
                                            {
                                                echo showSingleMicroBiology($test,$appointmentNumber);
                                            }
                                            elseif($gottenMessage == "Semen Analysis")
                                            {
                                                echo showSingleSemenAnalysis($test,$appointmentNumber);
                                            }
                                            elseif($gottenMessage == "laboratory")
                                            {
                                                echo showSingleLaboratory($test,$appointmentNumber);
                                            }
                                            else
                                            {}
