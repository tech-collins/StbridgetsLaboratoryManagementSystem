...
if(isset($_POST["submit"]))
{
    ...
    $referenceNumber = mysqli_real_escape_string($con,$_POST["patientReference"]);
    $empty_picture = "none";
    $passport_name = "";
    $folder = "";
    $extension = "";
    ...
    $passport_file = $_FILES['photo']['tmp_name'];
      ...
      else
      {
        if(move_uploaded_file($passport_file,$folder))
        {
            ...
            if($insert)
            {
                $patientNames = $surname." ".$firstname;
                updateAllTables($referenceNumber,$patientNames);
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
										...
										<div class="col-sm-12">
                                            ...
                                            <input type="hidden" name="patientReference" class="form-control" value="<?php echo $patientRef ?>" required>
										</div>
										</div>
