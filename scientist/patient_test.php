            ...
            <div class="content" style=" box-shadow: 0 1px 2px rgba(0,0,0,0.07), 
                ...
                <div class="row">
                    <div class="col-sm-5 col-4">
                        <h4 class="page-title">enter patient appointment number</h4>
                    </div>
						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody id="txtHint">
                                    ...
                                    ?>
									<tr>
										<td><a href="view-appointment.php?ref=<?php echo $res['patient_ref_no'];?>&today=<?php echo $res['appointment_date']; ?>&appN=<?php echo $res['appointment_no']; ?>"><?php echo $res['appointment_no']; ?></a></td>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="record_result.php?ref=<?php echo $res['patient_ref_no']; ?>&appNumber=<?php echo $res['appointment_no']; ?>"><i class="fa fa-pencil m-r-5"></i> capture result</a>
												</div>
											</div>
										</td>
									</tr>
