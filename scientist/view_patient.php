                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <!-- <div class="staff-msg"><a href="schedule_new_test.php?ref=<?php echo $patient_refs; ?>" class="btn" style="color:white; background-color: rgba(12, 184, 182, 0.91);">Schedule test</a></div>  -->
                                            </div>
                                        </div>
                                        <div class="col-md-7">
