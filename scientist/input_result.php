...
include 'input_result_display.php';
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <h4 class="page-title">Enter Test Results For</h4>
                        ...
                        <div class="col-sm-8 col-9 text-right m-b-20">
						 <a href="customize_test.php?test=<?php echo $tests; ?>" class="btn btn btn-primary btn-rounded float-right" style="background-color: rgba(12, 184, 182, 0.91);"><i class="fa fa-plus"></i> customize</a>
					    </div>
                    <?php
                    ...
                    <?php
                        echo displayHeamatology($tests, $appnum,$patientNames,$pat_ref);
                    ?>
                    <?php
                    ...
                    <?php
                        echo displayChemistry($tests, $appnum,$patientNames,$pat_ref);
                    }
                    ...
                    <?php
                        echo displayHomonalAssays($tests, $appnum,$patientNames,$pat_ref);
                    }
                    ...
                    <?php
                        echo displayMicroBiology($tests, $appnum,$patientNames,$pat_ref);
                    ?>
                    </div>
                    <?php
                    ...
                    <?php
                        echo displaySemenAnalysis($tests, $appnum,$patientNames,$pat_ref);
                    ...
                    <?php
                        echo displayLaboratories($tests, $appnum,$patientNames,$pat_ref);
                    ?>
                    </div>
                    <?php
                    }
                    elseif($returnedMessage == "other") {
                        ?>
                            ...
                            <div class="col-lg-8 offset-lg-2" style="align-content: center;">
                                <h3>Clinical Laboratory Report</h3>
                        <?php
                            echo displayOther($tests, $appnum,$patientNames,$pat_ref);
                        ?>
                        </div>
                        <?php
                        }
