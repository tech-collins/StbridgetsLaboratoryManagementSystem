            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							<a href="#"><i class="fa fa-hospital-o"></i></i> <span> Test </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="add_test.php">Manage Test</a></li>
								<li><a href="patient_test.php">Input Test Result</a></li>
								<li><a href="view_test.php">View Patient Result</a></li>
								<!-- <li><a href="taxes.php">Taxes</a></li>
								<li><a href="provident-fund.php">Provident Fund</a></li> -->
							</ul>
						</li>
						<li class="submenu">
							<a href="#"><i class="fa fa-search"></i> <span> Search </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="search_patient.php"> Patient </a></li>
								<li><a href="search_apointment.php"> Appointments </a></li>
							</ul>
						</li>
                        <!--
                        <li class="submenu">
