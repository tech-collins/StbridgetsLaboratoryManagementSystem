            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="index.php"><i class="fa fa-dashboard"></i style=" color:white;"> <span>Dashboard</span></a>
                        </li>
                        <li>
                        ...
                        <li class="submenu">
							<a href="#"><i class="fa fa-hospital-o"></i> <span>Test</span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="view_test.php"> View Tests</a></li>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a href="search_apointment.php">Appointment</a></li>
							</ul>
						</li>
                        <!--
						<li class="submenu">
