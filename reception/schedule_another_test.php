            ...
            <div class="content">
                ...
                <div class=>
                    <form method="POST" action="schedule_new_test.php">
                        ...
                        $_SESSION["patient_test"] = $tests;
                        $_SESSION["testAmount"] = $totalAmount;
                        ?>
                        <div class="m-t-20 text-center" style="margin-left: 5%;">
                            <a href="add_patient_two.php?payment='no'" class="btn btn-primary "> not paid </a>
                            <a href="add_patient_two.php?payment='yes'" class="btn btn-primary " style="background-color: rgba(12, 184, 182, 0.91);"> paid </a>
                            <a href="company_patient_name.php?company='company'&patientRef=<?php echo  $patient_ref; ?>" class="btn btn-warning mt-3"> company </a>
                        </div>
                    </form>
                </div>
                                        </div>
