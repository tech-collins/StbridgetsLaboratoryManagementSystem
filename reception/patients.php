...
if(isset($_GET["appNumber"]))
{
	$appointmentnumber= $_GET["appNumber"];
}
												...
												<td class="text-right">
													<div class="dropdown dropdown-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<!-- <a class="dropdown-item" href="#" onclick="queuePatient('<?php //echo $result['patient_ref_number']; ?>')"><i class="fa fa-pencil m-r-5"></i> Queue</a>  -->
