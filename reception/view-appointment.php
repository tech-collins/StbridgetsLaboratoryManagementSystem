        ...
        if (isset($_GET["ref"]) || isset($_POST["ref"])) {
            ...
            if ($search_patient) {
                while ($res_search = mysqli_fetch_assoc($search_patient)) {
                    ...
                    $patient_id = $res_search['id'];
                }
            } else {
            }
            $checkAppointment = mysqli_query($con, "SELECT * FROM appointments WHERE patient_ref_no='$patient_refs' AND appointment_no='$appNumber'");
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                ?>
                                                    <div class="staff-msg"><a href="add_new_appointment.php?ref=<?php echo $patient_ref; ?>" class="btn" style="color:white; background-color: rgba(12, 184, 182, 0.91);">Schedule test</a></div>
                                                <?php
                                                                ...
                                                                <div class="timeline-content">
                                                                    ...
                                                                    <span class="time"><b>
                                                                        <?php 
                                                                            ...
                                                                            {
                                                                                echo $result_search['appointment_date']."<h4 style='color: violet;'><b>(".$appointmnetStatus.")</b></h4>"; 
                                                                            ?>
                                                                            <?php
                                                                            }
                                                                        ?>
