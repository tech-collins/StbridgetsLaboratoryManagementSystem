...
function checkAppointment($refs)
{
    include 'fabinde.php';
    $returnMessage;
    $testStats = "";
    $checking = mysqli_query($con,"SELECT * FROM appointments WHERE patient_ref_no='$refs' ");
    if(mysqli_num_rows($checking))
    {
        while($tt = mysqli_fetch_assoc($checking))
        {
            $testStats = $tt['appointment_status'];
        }
    }
    if($testStats == "pending" || $testStats == "sample collected")
    {
        $returnMessage = "no";
    }
    else
...
<body>
    <div class="main-wrapper" style="background-color: rgb(240, 234, 214);">
        ...
        if (isset($_GET["ref"]) || isset($_POST["ref"])) {
            ...
            //$patient_ref = substr($patient_refs, 2, -2);
            $search_patient = mysqli_query($con, "SELECT * FROM patients WHERE patient_ref_number = '$patient_refs'");
            if ($search_patient) {
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="staff-id">Reference ID : <?php echo $patient_refs; ?></div>
                                                <?php 
                                                $checker = checkAppointment($patient_refs);
                                                if($checker == "no")
                                                {
                                                ?>
                                                    <div class="staff-msg"><a href="add_new_appointment.php?ref=<?php echo $patient_refs; ?>" class="btn" style="color:white; background-color: rgba(12, 184, 182, 0.91);">Schedule test</a></div>
                                                <?php
                                                }
                                                else
                                                {
                                ...
                                <div class="col-md-12">
                                    <div class="card-box">
                                        ...
                                        <div class="experience-box">
                                            ...
                                            $app_search = mysqli_query($con, "SELECT * FROM appointments WHERE patient_ref_no='$patient_refs' ORDER BY appointment_date DESC");
                                            if ($app_search) {
                                                $numberApp = mysqli_num_rows($app_search);
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="experience-content">
                                                                <div class="timeline-content">
                                                                    <a href="#" class="name"><?php echo $result_search['test_category']." (Test ".$result_search['appointment_status'].")"; ?></a>
                                                                    <div><?php 
                                                                    ...
                                                                    <span class="time"><b>
                                                                        ...
                                                                        {
                                                                            echo $result_search['appointment_date'];?><a href="all_result_view.php?ref=<?php echo $patient_refs; ?>&appointmentNo=<?php echo $result_search['appointment_no']; ?>"> -- View Result</a>
                                                                        <?php
                                                                        }
                                                                        else
                                                                        {
