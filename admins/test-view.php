        ...
        if (isset($_GET["ref"]) || isset($_POST["ref"])) {
            ...
            if ($search_patient) {
                while ($res_search = mysqli_fetch_assoc($search_patient)) {
                    ...
                    $parameter_tests = $res_search['test_parameters'];
                    $parameter_sub_test = $res_search['sub_parameters'];
                    $id = $res_search['id'];
                }
            } else {
            }
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <small class="text-muted"><?php //echo showAge($dob); ?> TEST</small>
                                                <div class="staff-id">Reference ID : <?php echo $t_ref; ?></div>
                                                <div class="staff-msg"><a href="edit-test.php?id=<?php echo $id; ?>" class="btn" style="color:white; background-color: rgba(12, 184, 182, 0.91);">Edit</a></div>
                                                <?php
                                                /**if($parameter_tests == "none")
                                                {
                                                ?>
                                                ...
                                                elseif($parameter_tests != "none" && $parameter_sub_test == "none")
                                                {
                                                ?>
                                                <div class="staff-msg"><a href="add_parametars.php?ref=<?php echo $t_ref; ?>" class="btn" style="color:white; background-color: rgba(12, 184, 182, 0.91);">Add Parametars</a></div>
                                                <div class="staff-msg"><a href="add_sub_categories.php?ref=<?php echo $t_ref; ?>" class="btn" style="color:white; background-color: rgba(12, 184, 182, 0.91);">Add Sub Parametars</a></div>  -->
                                                <?php
                                                }
                                                else
                                                {
                                ...
                                <div class="col-md-12">
                                    <div class="card-box">
                                        ...
                                        <div class="experience-box">
                                            <?php
                                            $patient_ref = "1";
                                            $app_search = mysqli_query($con, "SELECT * FROM test_categories WHERE test_ref='$t_ref'");
                                            if ($app_search) {
                                            ...
                                            ?>
                                                    <ul class="experience-list">
                                                        <li>
                                                            ...
                                                            <div class="experience-content">
                                                                <div class="timeline-content">
                                                                    ...
                                                                    <div>
                                                                    <?php 
                                                                    if($result_search['test_parameters'] != "none")
                                                                    {
                                                                        $tt = unserialize($result_search['test_parameters']);
                                                                    ...
                                                                    {
                                                                        echo "<b>".$result_search['test_parameters']."</b><br>";
                                                                    }
                                                                    ?></div>
                                                                    <!-- <span class="time"><b><?php //echo $result_search['date_updated']; ?></b></span> -->
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                        <div class="experience-content">
                                                                <div class="timeline-content">
                                                                <a href="#/" class="name">Sub-Paratmeters</a>
                                                                </div>
                                                                <div><?php 
                                                                if($result_search['sub_parameters'] != "none")
                                                                {
                                                                    $tss = unserialize($result_search['sub_parameters']);
                                                                    if(is_array($tss))
                                                                    {
                                                                        foreach ($tss as $subOption){
                                                                                    echo "<b>".$subOption."</b><br>";
                                                                                }
                                                                    }
                                                                    else
                                                                    {
                                                                        echo "<b>".$result_search['sub_parameters']."</b><br>";
                                                                    }
                                                                }
