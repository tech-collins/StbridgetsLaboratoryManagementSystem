...
if(isset($_POST["amount"]))
{
    ...
    $test_ref = $category;
            ...
            if($inserted)
            {
                $insert_status = "<h5 style='color: rgba(12, 184, 182, 0.91);'>TEST details edited successfully</h5>";
                header("location:add_test.php?status=$insert_status");
            }
            else
            {
                $insert_status = "<h5 style='color: red;'>TEST details Not edited successfully</h5>";
            }
