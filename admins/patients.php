					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
									<?php
									$query = mysqli_query($con, "SELECT * FROM patients ORDER BY date_registered ASC");
									if ($query) {
												...
												<td class="text-right">
													<div class="dropdown dropdown-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="edit-patient.php?id=<?php echo $result['id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
															<!-- <a class="dropdown-item" onclick="queuePatient('<?php //echo $result['id']; ?>')" href="#"><i class="fa fa-pencil m-r-5"></i> Queue</a> -->
