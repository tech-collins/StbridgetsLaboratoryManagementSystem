...
<head>
    ...
    <title>St Bridget - Medical Laboratory Management System</title>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-8 text-right m-b-30">
                            <div class="btn-group btn-group-sm">
                                <!-- <a href="#?ref=<?php ///echo $patient_reference; 
                                                    ?>&appointment=<?php //echo $appointmentNumber; 
                                                                                                        ?>" class="btn btn-white">CSV</a> -->
                                <!-- <a href="view_pdf_test.php?ref=<?php //echo $patient_reference; ?>&appointment=<?php //echo $appointmentNumber; ?>&test=<?php //echo $testName; 
                                                                                                                                                    ?>" class="btn btn-white" id="pdfPrint">PDF</a> -->
                <a href="#" class="btn btn-white" id="pdfPrint" onclick="pdfShow()">PDF</a>
                                <!-- <button class="btn btn-white"><i class="fa fa-print fa-lg"></i> Print</button> -->
                            </div>
                        </div>
                        <input type="hidden" name="patientRef" id="patientRef" value="<?php echo $patient_reference; ?>">
                        <input type="hidden" name="appointmentNumber" id="appointmentNumber" value="<?php echo $appointmentNumber; ?>">
                        <input type="hidden" name="test" id="testName" value="<?php echo $testName; ?>">
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
    ...
    <script type="text/javascript">
        function pdfShow()
        {
            ...
            window.open('view_pdf_test.php?ref=' + patientRef +'&appointment=' + appointmentNumber, '_blank');
        }
        /*pdfButton = document.getElementById('pdfPrint');
        <?php
        ...
        pdfButton.onclick = function(){
            var patientRef = document.getElementById('patientRef').value;
            var appointmentNumber = document.getElementById('appointmentNumber').value;
            window.open('receipt_printer.php?ref=' + patientRef + appointmentNumber, '_blank');
        }*/
