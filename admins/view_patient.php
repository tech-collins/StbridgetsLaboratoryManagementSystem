                                                            ...
                                                            <div class="experience-content">
                                                                <div class="timeline-content">
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        {
                                                                            echo $result_search['appointment_date'];?><a href="all_result_view.php?ref=<?php echo $patient_ref; ?>&appointmentNo=<?php echo $result_search['appointment_no']; ?>"> -- View Result</a>
                                                                        <?php
                                                                        }
                                                                        else
                                                                        {
