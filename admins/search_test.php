                            ...
                            <table class="table table-border table-striped custom-table datatable mb-0">
                                ...
                                <tbody id="txtHint">
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $dd; ?></td>
                                                <td><a href="test-view.php?ref=<?php echo $result['test_ref']; ?>"><?php echo strtoupper($result['test_type']); ?></a></td>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" href="edit-test.php?id=<?php echo $result['id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
