...
$this->Cell(150);
    ...
    $this->Cell(37,6,$haematologySpecimen,1);
...
function displayMicrobiologyPdf($testRef,$appointmentNo)
{
    ...
    $this->Cell(150);
        ...
        $this->Cell(40,6,$doctor,1);
        $this->Cell(24,6,'SPECIMENN',1);
        $this->Cell(37,6,$microBiologySpecimen,1);
        $this->Cell(30,6,'DATE RECEIVED',1);
        $this->Cell(36,6,$dateAppointment,1,1);
...
function displayChemistryPdf($testRef,$appointmentNo)
{
    ...
    $this->Cell(150);
        ...
        $this->Cell(55,10,'',0);
        $this->SetTextColor(220,50,50);
        $this->Cell(20,5,'CLINICAL CHEMISTRY RESULT FORM',0,1);
        $this->SetTextColor(0,0,0);
        $this->Cell(30,2,'',0,1);
...
function displaySemenPdf($testRef,$appointmentNo)
{
    ...
    $this->Cell(150);
        ...
        $this->Cell(55,10,'',0);
        $this->SetTextColor(220,50,50);
        $this->Cell(20,5,'SEMEN ANALYSIS RESULT FORM',0,1);
        $this->SetTextColor(0,0,0);
        $this->Cell(30,2,'',0,1);
...
function displayLaboratoryPdf($testRef,$appointmentNo)
{
    ...
    $this->Cell(150);
        ...
        $this->Cell(30,5,$laboratoryReport,0,1);
